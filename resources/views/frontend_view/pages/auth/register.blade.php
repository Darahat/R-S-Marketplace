                ...
                <div id="register-step-2" class="space-y-3 hidden">
                    ...
                    <div class="flex items-start">
                        ...
                        <label for="terms" class="ml-2 block text-xs sm:text-sm text-gray-900">
                            I agree to the <a href="{{ route('terms') }}" class="text-primary hover:text-secondary underline">Terms</a> and <a href="{{ route('privacy.policy') }}" class="text-primary hover:text-secondary underline">Privacy Policy</a>
                        </label>
                    </div>
                </div>
