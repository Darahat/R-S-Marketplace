    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between py-1.5 text-xs">
            ...
            <div class="flex items-center divide-x divide-white/30">
                ...
                @guest
                    <button type="button" @click="loginModalOpen = true" class="px-4 hover:text-yellow-200 transition-colors font-medium">Login</button>
                    <button type="button" @click="registerModalOpen = true" class="pl-4 hover:text-yellow-200 transition-colors font-medium">Sign Up</button>
                @else
