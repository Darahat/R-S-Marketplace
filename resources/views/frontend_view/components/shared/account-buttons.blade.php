...
<div class="relative">
    @auth
        <button id="nav-avatar-button"
    @click.stop="toggleAccount()" class="relative p-1.5 rounded-full hover:bg-gray-100 transition-colors" title="Account">
            <img
    ...
    @else
        <button type="button"  @click="loginModalOpen = true" class="flex flex-col items-center p-2 text-gray-600 hover:text-primary transition-colors" title="Login / Sign Up">
