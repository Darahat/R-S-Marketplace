...
<div class="hidden md:flex md:flex-shrink-0">
  <div class="flex flex-col w-64 bg-gradient-to-b from-primary via-primary-dark to-secondary">
      <div class="flex items-center justify-center h-16 px-4 border-b border-white border-opacity-20">
        <a href="{{route('home')}}"><span class="text-white text-xl font-semibold">R&SMarketPlace</span></a>
      </div>
