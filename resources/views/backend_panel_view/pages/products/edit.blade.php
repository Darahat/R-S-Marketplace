                        ...
                        <div class="card shadow-sm mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-info mb-0">
                                    <h6 class="mb-2"><i class="fas fa-info-circle"></i> Product Statistics</h6>
                                    <small>
                                        <strong>Created:</strong> {{ $product->created_at->format('M d, Y h:i A') }}<br>
                                        <strong>Last Updated:</strong> {{ $product->updated_at->format('M d, Y h:i A') }}<br>
                                        <strong>Total Sold:</strong> {{ $product->sold_count }} units<br>
                                        <strong>Current Rating:</strong> {{ $product->rating }} / 5
                                    </small>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="image" class="form-label">
                                    {{ $product->image ? 'Change' : 'Upload' }} Image
                                </label>
                                <input type="file"
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="is_best_selling" name="is_best_selling" value="1" {{ old('is_best_selling', $product->is_best_selling) ? 'checked' : '' }}>
                            ...
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="is_latest" name="is_latest" value="1" {{ old('is_latest', $product->is_latest) ? 'checked' : '' }}>
                            ...
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input" type="checkbox" id="is_todays_deal" name="is_todays_deal" value="1" {{ old('is_todays_deal', $product->is_todays_deal) ? 'checked' : '' }}>
