...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="fas fa-sitemap"></i> {{ $page_header }}</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm">
                        <div class="card-header bg-info text-white">
                            <h3 class="card-title"><i class="fas fa-tree"></i> Category Tree</h3>
                        </div>
                        <div class="card-body">
                            <div id="categoryTree">
                                @foreach($rootCategories as $root)
                                    @include('backend_panel_view_admin.pages.categories.partials.tree_item', ['category' => $root, 'level' => 0])
                                @endforeach
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-8">
                    <div class="card shadow-sm">
                        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                            <h3 class="card-title mb-0"><i class="fas fa-list"></i> All Categories</h3>
                            ...
                            <table class="table table-hover table-striped text-nowrap align-middle mb-0">
                                <thead class="bg-light">
                                    <tr>
                                        ...
                                        <th width="10%" class="text-center">Products</th>
                                            ...
                                            <td class="text-center">
                                                <div class="form-check form-switch d-inline-block">
                                                    <input class="form-check-input featured-toggle" type="checkbox"
                                                           data-id="{{ $category->id }}" {{ $category->is_featured ? 'checked' : '' }}>
                                                </div>
                                            </td>
                                            <td class="text-center">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="fas fa-info-circle"></i> Category Details</h5>
...
$(document).ready(function() {
    ...
    $('.view-btn').on('click', function() {
        ...
        $.ajax({
            ...
            error: function() {
                $('#categoryDetails').html('<p class="text-danger">Failed to load category details.</p>');
            }
        });
    });
